...
import com.dawn.chaos.pvp.service.impl.AnswerServiceImpl;
import com.dawn.chaos.pvp.utils.SpringUtils;
...
@ComponentScan(basePackages = {"com.dawn.chaos.pvp", "com.dawn.websocket"})
public class DawnChaosApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringUtils.getBean(AnswerService.class);
    }
}
